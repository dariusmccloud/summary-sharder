...
export function schemaStatements() {
    return [
        ...
        `CREATE TABLE IF NOT EXISTS interpretation_synthesis_policies (
            ...
            allowed_assertion_domains_json TEXT NOT NULL,
            prohibited_domains_json TEXT NOT NULL,
            manual_trigger_required_for_high_risk INTEGER NOT NULL,
            max_candidates_per_run INTEGER NOT NULL,
            policy_hash TEXT NOT NULL,
            details_json TEXT NOT NULL,
            created_at INTEGER NOT NULL,
            PRIMARY KEY (synthesis_policy_id, policy_version)
        )`,
        `CREATE TABLE IF NOT EXISTS interpretation_synthesis_runs (
            ...
            requested_interpretation_types_json TEXT NOT NULL,
            requested_assertion_domains_json TEXT NOT NULL,
            shared_relationship_requested INTEGER NOT NULL,
            personal_meaning_requested INTEGER NOT NULL,
            max_candidates_requested INTEGER NOT NULL,
            generated_candidate_ids_json TEXT NOT NULL,
            run_status TEXT NOT NULL,
            failure_code TEXT,
            failure_details_json TEXT,
            created_by_entity_id TEXT NOT NULL,
            manual_trigger_acknowledged INTEGER NOT NULL,
            created_at INTEGER NOT NULL,
            updated_at INTEGER NOT NULL
        )`,
        ...
        `CREATE TABLE IF NOT EXISTS interpretation_publication_authorizations (
            ...
            qualification_binding_hash TEXT NOT NULL,
        ...
        `CREATE TABLE IF NOT EXISTS dnm_publication_records (
            dnm_record_id TEXT PRIMARY KEY,
            continuity_target_id TEXT NOT NULL,
            memory_subject_id TEXT NOT NULL,
            memory_scope_id TEXT NOT NULL,
            source_interpretation_revision_id TEXT NOT NULL,
            source_interpretation_id TEXT NOT NULL,
            published_statement TEXT NOT NULL,
            proposal_content_hash TEXT NOT NULL,
            grounding_binding_mode TEXT NOT NULL,
            grounding_envelope_hash TEXT NOT NULL,
            grounding_protocol_version INTEGER NOT NULL,
            grounding_source_set_hash TEXT NOT NULL,
            review_envelope_hash TEXT NOT NULL,
            publication_policy_id TEXT NOT NULL,
            publication_policy_version INTEGER NOT NULL,
            publication_policy_hash TEXT NOT NULL,
            publication_state TEXT NOT NULL,
